...
(function(){
	...
	jQuery("tr:contains('Dimensions') fieldset").after(
		'<div id="quicksizeselect">\
			...
			<button type="button" style="margin-top: 5px; border-radius: 0; -webkit-border-radius: 0; vertical-align: bottom; width: 136px; height: 176px; cursor: pointer;">11 x 8.5</button>\
			<button type="button" style="margin-top: 5px; border-radius: 0; -webkit-border-radius: 0; vertical-align: bottom; width: 88px; height: 136px; cursor: pointer;">8.5 x 5.5</button>\
			<button type="button" style="margin-top: 5px; border-radius: 0; -webkit-border-radius: 0; vertical-align: bottom; width: 68px; height: 88px; cursor: pointer;">5.5 x 4.25</button>\
			<button type="button" style="margin-top: 5px; border-radius: 0; -webkit-border-radius: 0; vertical-align: bottom; width: 44px; height: 68px; cursor: pointer;">4.25 x 2.75</button>\
			</span>\
			<span style="display: inline-block;">\
			<button type="button" style="margin-top: 5px; border-radius: 0; -webkit-border-radius: 0; vertical-align: bottom; width: 176px; height: 136px; cursor: pointer;">8.5 x 11</button>\
			<button type="button" style="margin-top: 5px; border-radius: 0; -webkit-border-radius: 0; vertical-align: bottom; width: 136px; height: 88px; cursor: pointer;">5.5 x 8.5</button>\
			<button type="button" style="margin-top: 5px; border-radius: 0; -webkit-border-radius: 0; vertical-align: bottom; width: 88px; height: 68px; cursor: pointer;">4.25 x 5.5</button>\
			<button type="button" style="margin-top: 5px; border-radius: 0; -webkit-border-radius: 0; vertical-align: bottom; width: 68px; height: 44px; cursor: pointer;">2.75 x 4.25</button>\
			</span>\
		</div>');
